...
<base href="<%=basePath%>">
<link rel="icon" href="https://218.76.15.8:18080"> <!-- sgcc测试地址 -->
<title>电子商务系统测试</title>
<style type="text/css">
...
jQuery(function () {  
    ...
    jQuery("#Verify").click(function(){
    	jQuery(this).attr("src","sgcc/commonsys/SecurityCodeImageAction.action?timestamp="+new Date().getTime());
    });
});
</script>
</head>
